      ...
      <div className='flex-1'>
        {location.pathname === "/mypage" ? (
          <div className='max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8'>
            <div className='mb-8'>
              <h1 className='text-2xl font-bold text-gray-900'>MyPage Dashboard</h1>
              ...
              <div className='p-6'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <Link
                    ...
                    <div>
                      <h3 className='font-medium text-gray-900'>Manage Resumes</h3>
                      <p className='text-sm text-gray-500'>Upload or update your resumes</p>
                    </div>
                  </Link>
                </div>
              </div>
